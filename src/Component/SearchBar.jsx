      ...
      <form className="w-[70vw]">
        ...
        <div className="relative">
          ...
          <input
            type="search"
            id="default-search"
            className="block w-full p-4 pl-10 text-sm rounded-xl border text-dimWhite border-gray-700 bg-black-gradient-2 shadow-sm outline-none focus:z-10 focus:border-secondary focus:ring-secondary"
